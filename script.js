const inputElement = document.querySelector(".txttitulo");
const addTaskButton = document.querySelector(".task-criar");
const tasksContainer = document.querySelector(".afazer");
